...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.csrf_token_validate_listener' => 'getApp_CsrfTokenValidateListenerService',
            'app.user_provider' => 'getApp_UserProviderService',
            ...
            'twig' => 'getTwigService',
            'twig.app_extension' => 'getTwig_AppExtensionService',
            'twig.controller.exception' => 'getTwig_Controller_ExceptionService',
            'twig.controller.preview_error' => 'getTwig_Controller_PreviewErrorService',
            'twig.exception_listener' => 'getTwig_ExceptionListenerService',
            'twig.html_extension' => 'getTwig_HtmlExtensionService',
    ...
    /**
     * Gets the 'app.csrf_token_validate_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Listener\CsrfTokenValidateListener A AppBundle\Listener\CsrfTokenValidateListener instance
     */
    protected function getApp_CsrfTokenValidateListenerService()
    {
        return $this->services['app.csrf_token_validate_listener'] = new \AppBundle\Listener\CsrfTokenValidateListener($this);
    }

    /**
     * Gets the 'app.user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getApp_UserProviderService()
    {
        return $this->services['app.user_provider'] = new \AppBundle\Security\UserProvider($this->get('biz'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Biz\BizKernel A Biz\BizKernel instance
     */
    protected function getBizService()
    {
        return $this->services['biz'] = new \Biz\BizKernel(array('database' => array('name' => 'user_manage_system_test', 'user' => 'root', 'password' => 123456, 'host' => '127.0.0.1', 'port' => 3306, 'driver' => 'pdo_mysql', 'charset' => 'UTF8')), $this);
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'app.csrf_token_validate_listener', 1 => 'onKernelRequest'), 255);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'user_manage_system_test', 'user' => 'root', 'password' => 123456, 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Codeages\\Biz\\Framework\\Dao\\Connection', 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c3604a8db70ee5497afe383e54aacdbd6df023014955c09e29cd8b7ec5dc2b56');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Security\\CurrentUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha256', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/leader');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/leader$');

        $n = new \Symfony\Component\Security\Http\AccessMap();
        $n->add($h, array(0 => 'ROLE_ADMIN'), NULL);
        $n->add($i, array(0 => 'IS_AUTHENTICATED_REMEMBERED'), NULL);
        $n->add($j, array(0 => 'ROLE_USER'), NULL);
        $n->add($k, array(0 => 'IS_AUTHENTICATED_REMEMBERED'), NULL);
        $n->add($l, array(0 => 'ROLE_LEADER'), NULL);
        $n->add($m, array(0 => 'IS_AUTHENTICATED_REMEMBERED'), NULL);

        $o = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $p = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('lifetime' => 8640000, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AppBundle\Twig\AssetHelperExtension($this));
        $instance->addExtension($this->get('twig.app_extension'));
        $instance->addExtension($this->get('twig.html_extension'));
        ...
        $instance->addGlobal('default_csrf_token_id', 'app');
    ...
    /**
     * Gets the 'twig.app_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Twig\AppExtensions A AppBundle\Twig\AppExtensions instance
     */
    protected function getTwig_AppExtensionService()
    {
        return $this->services['twig.app_extension'] = new \AppBundle\Twig\AppExtensions($this);
    }
    ...
    /**
     * Gets the 'twig.html_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getTwig_HtmlExtensionService()
    {
        return $this->services['twig.html_extension'] = new \AppBundle\Twig\HtmlExtension();
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('app.user_provider'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'ThisTokenIsNotSoSecretChangeIt', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57b5ac74755aa3.68378687')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER', 2 => 'ROLE_LEADER'), 'ROLE_LEADER' => array(0 => 'ROLE_LEADER', 1 => 'ROLE_USER')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'user_manage_system_test',
            'database_user' => 'root',
