...
{   
    ...
    */
    ...
    public function testUpdate()
    {
        ...
        $user = $this->getUserService()->updateAll($id, $userTest);
     ...
     * @dataProvider additionProvider
     */
    public function testGetCompleteInfo($data)
    {
        $user = $this->getUserService()->createUser($data);
        $id = 1;
        $resultData = $this->getUserService()->getCompleteinfo($id);
     ...
     * @dataProvider additionProvider
     */
    public function testGetOtherInfoByUserId($data)
    {
        $insertUser = $this->getUserService()->createUser($data);

        $otherInfo = $this->getUserService()->getOtherInfoByUserId($insertUser['id']);
        ...
        $this->assertEquals($otherInfo, $other);
